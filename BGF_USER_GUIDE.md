...
11. [Operating Modes Explained](#11-operating-modes-explained)
12. [What the AI Tiers Mean](#12-what-the-ai-tiers-mean)
...
If any gate failed, the pipeline is in HARD HALT. See [When Something Fails](#13-when-something-fails).
...
After an episode has been live for 24–48 hours, pull the numbers from YouTube Studio and enter them:
